...
void NhapTenSach(string &result, int &ordinal, bool &isSave, bool &isEscape, bool isEdited)
{
...
//	{
		...
		if(_kbhit())
		{
			...
			else if (kb_hit == ESC)
			{
				...
				gotoxy(85 + (nngang / 3) + 24, yDisplay + 3);
...
void NhapTenTacGia(string &result, int &ordinal, bool &isSave, bool &isEscape, bool isEdited)
{
	ShowCur(true);
	// bien dem so chu da duoc nhap vao cho result
	 cout << result;

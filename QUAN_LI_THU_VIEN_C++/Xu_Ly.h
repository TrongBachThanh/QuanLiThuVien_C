...
void Introduce()
{
	...
	gotoxy(xTen+10, yTen);
	cout << "HOTEN : BACH THANH TRONG";
	gotoxy(xTen+10, yTen + 1);
	cout << "MSSV  : N15DCAT022";
	gotoxy(xTen+10, yTen + 2);
	cout << "LOP   : D15CQAT01-N";
...
int Menu_MuonSach(LIST_DAUSACH &lDS, NODE_DG* nDG)
{
	...
	char thongbao4[] = "					Sach trong dau sach nay da duoc muon het !!!";
	normalBGColor();
			...
			do
			{
				while (_kbhit())
				{
					...
					case  KEY_F3:
						...
						i1 = -1;
						for (NODE_MT  pMT = temp->dsmt.pHead; pMT != NULL; pMT = pMT->right)
						{
